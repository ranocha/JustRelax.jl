...
@views function Stokes2D_vep()
    ...
    for it in 1:nt
        ...
        p2 = heatmap(xc, yc, Pt' , aspect_ratio=1, xlims=(dx/2, Lx-dx/2), ylims=(0, Ly), c=:inferno, title="η_vep")
        p3 = heatmap(xc, yc, Txx' , aspect_ratio=1, xlims=(dx/2, Lx-dx/2), ylims=(0, Ly), c=:inferno, title="τii")
