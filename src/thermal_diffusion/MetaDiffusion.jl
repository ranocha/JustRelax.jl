    ...
    @eval begin
        struct ThermalArrays{_T}
            ...
            function ThermalArrays(ni::NTuple{1,Integer})
                ...
                qTx2 = @zeros(nx - 1)
                ResT = @zeros(nx - 2)
                return new{typeof(T)}(T, ΔT, Told, qTx, qTx2, ResT)
            end
            ...
            function ThermalArrays(ni::NTuple{2,Integer})
                ...
                ResT = @zeros((ni .- 2)...)
                return new{typeof(T)}(T, ΔT, Told, qTx, qTy, qTx2, qTy2, ResT)
            end
            ...
            function ThermalArrays(ni::NTuple{3,Integer})
                ...
                ResT = @zeros((ni .- 2)...)
                return new{typeof(T)}(T, ΔT, Told, qTx, qTy, qTz, qTx2, qTy2, qTz2, ResT)
            end
        end
    end
end
