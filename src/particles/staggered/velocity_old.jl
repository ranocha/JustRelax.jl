...
function _grid2particle_xcell_edge(
    ...
    Fi, xci = @inbounds edge_nodes(F, p_i, xi_vx, dxi, idx)
...
# Get field F at the centers of a given cell
Base.@propagate_inbounds function edge_nodes(
...
@inline function vertex_offset(xi::NTuple{2, Any}, pxi::NTuple{2, Any}, di::NTuple{2, Any})
